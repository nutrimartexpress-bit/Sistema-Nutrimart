...
import { Shield, Database, Save, HardDrive, CheckCircle, AlertTriangle, RotateCcw } from 'lucide-react';
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="mt-8 flex justify-center gap-4">
                ...
                <button
                    disabled
                    className="flex items-center gap-2 px-6 py-3 bg-gray-200 text-gray-500 rounded-full cursor-not-allowed font-medium transition-all"
                >
                    <Save className="w-5 h-5" />
                    Backup Automático Programado (Próximamente)
                </button>
            </div>
        </div>
    );
